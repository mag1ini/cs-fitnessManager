...
namespace Authentication.Data
{
    public class AuthenticationDbContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            {
                new Permission {Id = 1, PermissionType = PermissionType.EditOwnProfile},
                new Permission {Id = 2, PermissionType = PermissionType.AssignTrainingToSelf},
            };
            ...
            modelBuilder.Entity<Role>()
                .HasData(new Role[]
                {
                    ...
                    new Role
                    {
                        Id = 1, Name = "Client", Permissions = permissions
                    },
                    //// Coach
                    //new Role
                    //{
